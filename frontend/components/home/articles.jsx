    ...
    return (
        <ul className="articles-list-wrapper">
            <li className="article-div">
                <img src={ window.article1URL} className="article-img" />
            ...
            <li className="article-div">
                <img src={ window.article2URL} className="article-img" />
                <div className="article-body">
            ...
            <li className="article-div">
                <img src={ window.article3URL} className="article-img" />
                <div className="article-body">
            ...
            <li className="article-div">
                <img src={window.article4URL} className="article-img" />
                <div className="article-body">

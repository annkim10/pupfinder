...
pup2 = Pup.create(org_id: org1.id, pup_name: 'Holly', pup_breed: 'Rat Terrier & Shepherd Mix', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Holly is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Holly today!")
...
pup3 = Pup.create(org_id: org1.id, pup_name: 'Lupita', pup_breed: 'Schnauzer & American Staffordshire Terrier Mix', pup_size: 'Small', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Lupita is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Lupita today!")
...
pup4 = Pup.create(org_id: org1.id, pup_name: 'Laika', pup_breed: 'Shepherd & Bloodhound Mix', pup_size: 'Small', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Laika is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Laika today!")
...
pup5 = Pup.create(org_id: org1.id, pup_name: 'Virginia', pup_breed: 'Hound Mix', pup_size: 'Small', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Virginia is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Virginia today!")
...
pup6 = Pup.create(org_id: org1.id, pup_name: 'Doreen', pup_breed: 'Mixed Breed', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Doreen is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Doreen today!")
...
pup7 = Pup.create(org_id: org1.id, pup_name: 'Baby', pup_breed: 'Mixed Breed', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Baby is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Baby today!")
...
pup8 = Pup.create(org_id: org1.id, pup_name: 'Starfire', pup_breed: 'Staffordshire Bull Terrier Mix', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Starfire is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Starfire today!")
...
pup9 = Pup.create(org_id: org1.id, pup_name: 'Olivia', pup_breed: 'Beagle', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Olivia is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Olivia today!")
...
pup10 = Pup.create(org_id: org1.id, pup_name: 'Thena', pup_breed: 'Mixed Breed', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Puppy', pup_bio: "Thena is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Thena today!")
...
pup11 = Pup.create(org_id: org2.id, pup_name: 'Cece', pup_breed: 'Chihuahua', pup_size: 'Small', pup_gender:'Female', pup_age: 'Adult', pup_bio: "Cece is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Cece today!")
...
pup12 = Pup.create(org_id: org2.id, pup_name: 'Daisy', pup_breed: 'Chihuahua & Terrier Mix', pup_size: 'Small', pup_gender:'Female', pup_age: 'Adult', pup_bio: "Daisy is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Daisy today!")
...
pup13 = Pup.create(org_id: org2.id, pup_name: 'Hershey', pup_breed: 'Labrador Retriever & Staffordshire Bull Terrier Mix', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Adult', pup_bio: "Hershey is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Hershey today!")
...
pup14 = Pup.create(org_id: org2.id, pup_name: 'Sparky', pup_breed: 'Jack Russell Terrier & Dachshund Mix', pup_size: 'Medium', pup_gender:'Male', pup_age: 'Adult', pup_bio: "Sparky is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Sparky today!")
...
pup15 = Pup.create(org_id: org2.id, pup_name: 'Laney', pup_breed: 'Pit Bull Terrier & Labrador Retriever Mix', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Adult', pup_bio: "Laney is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Laney today!")
...
pup16 = Pup.create(org_id: org2.id, pup_name: 'Silas', pup_breed: 'American Staffordshire Terrier Mix', pup_size: 'Large', pup_gender:'Male', pup_age: 'Adult', pup_bio: "Silas is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Silas today!")
...
pup17 = Pup.create(org_id: org2.id, pup_name: 'Beau', pup_breed: 'Hound Mix', pup_size: 'Large', pup_gender:'Male', pup_age: 'Adult', pup_bio: "Beau is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Beau today!")
...
pup18 = Pup.create(org_id: org2.id, pup_name: 'Nick', pup_breed: 'Labrador Retriever Mix', pup_size: 'Large', pup_gender:'Male', pup_age: 'Adult', pup_bio: "Nick is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Nick today!")
...
pup19 = Pup.create(org_id: org2.id, pup_name: 'Duke', pup_breed: 'Treeing Walker Coonhound Mix', pup_size: 'Large', pup_gender:'Male', pup_age: 'Adult', pup_bio: "Duke is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Duke today!")
...
pup20 = Pup.create(org_id: org2.id, pup_name: 'Jillian', pup_breed: 'Yorkshire Terrier', pup_size: 'Small', pup_gender:'Female', pup_age: 'Senior', pup_bio: "Jillian is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Jillian today!")
...
pup21 = Pup.create(org_id: org3.id, pup_name: 'Morris', pup_breed: 'Maltese & Maltipoo Mix', pup_size: 'Small', pup_gender:'Male', pup_age: 'Senior', pup_bio: "Morris is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Morris today!")
...
pup22 = Pup.create(org_id: org3.id, pup_name: 'Diamond', pup_breed: 'Pit Bull Terrier Mix', pup_size: 'Large', pup_gender:'Female', pup_age: 'Senior', pup_bio: "Diamond is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Diamond today!")
...
pup23 = Pup.create(org_id: org3.id, pup_name: 'Chloe', pup_breed: 'Boxer', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Senior', pup_bio: "Chloe is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Chloe today!")
...
pup24 = Pup.create(org_id: org3.id, pup_name: 'Rhonda', pup_breed: 'Labrador Retriever Mix', pup_size: 'Medium', pup_gender:'Female', pup_age: 'Senior', pup_bio: "Rhonda is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and she is spayed. Introduce yourself to Rhonda today!")
...
pup25 = Pup.create(org_id: org3.id, pup_name: 'Otis', pup_breed: 'Shepherd Mix', pup_size: 'Medium', pup_gender:'Male', pup_age: 'Senior', pup_bio: "Otis is a friendly, sweet and patient pup who is good with other dogs. Vaccinations are up to date and he is neutered. Introduce yourself to Otis today!")
